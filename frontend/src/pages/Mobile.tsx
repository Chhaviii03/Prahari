    ...
    <div className="max-w-sm mx-auto min-h-screen bg-bg-base p-4">
      <div className="flex items-center justify-between mb-4 pt-2">
        <div>
          ...
          <p className="text-xs text-text-secondary">{user?.name || 'Field Worker'}</p>
        </div>
        <div className="flex items-center gap-2">
          {offline ? <WifiOff size={14} className="text-sev-active" /> : <Wifi size={14} className="text-sev-ok" />}
          {onLogout && (
            <button onClick={onLogout} className="text-text-secondary p-1">
              <LogOut size={16} />
            </button>
          )}
        </div>
      ...
      {hazardous ? (
        <div className="bg-sev-critical/20 border-2 border-sev-critical rounded-xl p-6 mb-4 text-center">
          ...
          <p className="text-xs text-text-secondary mt-2">Do NOT enter. Await supervisor instructions.</p>
        ...
        <div className="bg-sev-ok/20 border-2 border-sev-ok rounded-xl p-6 mb-4 text-center">
          ...
          <p className="text-sm text-text-secondary">No active compound hazards in your zone</p>
        </div>
      )}
        ...
        <div className="bg-bg-surface rounded-xl border border-gray-800 p-4 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2 text-sm">
            <div className="bg-bg-base rounded p-2">
              <div className="text-[10px] text-text-secondary">CRS</div>
            ...
            <div className="bg-bg-base rounded p-2">
              <div className="text-[10px] text-text-secondary">Forecast</div>
