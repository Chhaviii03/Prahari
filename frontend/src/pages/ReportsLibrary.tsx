    ...
    <div className="p-4 h-full flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto space-y-2">
        ...
        {reports.map((r) => {
          ...
          return (
            <div key={r.report_id} className="bg-bg-surface border border-gray-800 rounded-lg p-4 flex items-center justify-between gap-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  {r.zone_id && <div className="text-[10px] text-text-secondary">Zone {r.zone_id}</div>}
                </div>
              </div>
              <div className="flex gap-2 shrink-0">
                {r.risk_id && (
                  <button
                    ...
                    className="text-xs border border-gray-700 px-3 py-1.5 rounded hover:border-accent"
                  >
                    View
                  </button>
                )}
                {r.exportable && r.risk_id && (
                  <button
                    ...
                    className="text-xs bg-accent text-white px-3 py-1.5 rounded flex items-center gap-1 disabled:opacity-50"
                  >
